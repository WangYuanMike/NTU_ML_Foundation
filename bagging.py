...
def bagging(T, lamb, train_x, train_y, test_x, test_y):
    ...
    for t in range(T):
        ...
        predict_y_in, _ = model.predict(boot_train_x, boot_train_y)
    ...
    return bagging_y_in, bagging_y_out, krr.get_error(boot_train_y, bagging_y_in), krr.get_error(test_y, bagging_y_out)
